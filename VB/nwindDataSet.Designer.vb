...
Partial Public Class nwindDataSet
    ...
    Partial Public Class ProductsDataTable
        ...
        Public Overloads Function AddProductsRow(ByVal ProductName As String, ByVal parentSuppliersRowBySuppliersProducts As SuppliersRow, ByVal CategoryID As Integer, ByVal QuantityPerUnit As String, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short, ByVal UnitsOnOrder As Short, ByVal ReorderLevel As Short, ByVal Discontinued As Boolean, ByVal EAN13 As String) As ProductsRow
            ...
            Dim columnValuesArray() As Object = New Object() {Nothing, ProductName, Nothing, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued, EAN13}
    ...
    Partial Public Class CategoryProductsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddCategoryProductsRow(ByVal parentSuppliersRowBySuppliers_CategoryProducts As SuppliersRow, ByVal ProductName As String, ByVal CategoryName As String, ByVal Picture() As Byte, ByVal Description As String) As CategoryProductsRow
            Dim rowCategoryProductsRow As CategoryProductsRow = CType(Me.NewRow,CategoryProductsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Nothing, ProductName, CategoryName, Picture, Description}
            If (Not (parentSuppliersRowBySuppliers_CategoryProducts) Is Nothing) Then
    ...
    Partial Public Class SuppliersRow
        ...
        Public Function GetCategoryProductsRows() As CategoryProductsRow()
            If (Me.Table.ChildRelations("Suppliers_CategoryProducts") Is Nothing) Then
                Return New CategoryProductsRow(-1) {}
            Else
...
Namespace nwindDataSetTableAdapters
    ...
    Partial Public Class SuppliersTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As nwindDataSet.SuppliersDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As nwindDataSet.SuppliersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As nwindDataSet.SuppliersDataTable = New nwindDataSet.SuppliersDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As nwindDataSet.SuppliersDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
